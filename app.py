...
"""EAU Confessions Bot - aiogram v3 compatible

This file is rewritten to use aiogram v3 APIs (Dispatcher message.register, MemoryStorage from v3, etc.).
Configuration is read from environment variables; do NOT store tokens in source.
"""
import os
import logging
import sqlite3
